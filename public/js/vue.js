...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    postImage: function postImage(post) {
      var _post$image;

      return (_post$image = post.image) !== null && _post$image !== void 0 ? _post$image : "https://www.logistec.com/wp-content/uploads/2017/12/placeholder.png";
    }
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    logoutMethod: function logoutMethod() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/logout").then(function (resp) {
        _this2.user = null;
        localStorage.removeItem("user");
        window.dispatchEvent(new CustomEvent("storedUserChanged"));
      });
...
var render = function () {
  ...
  return _c("section", [
    _c("div", { staticClass: "card-box my-3" }, [
      _c("img", { attrs: { src: _vm.postImage(_vm.postProp), alt: "" } }),
      _vm._v(" "),
      _c("div", { staticClass: "card-body" }, [
        _c("h5", { staticClass: "card-title" }, [
          _vm._v(_vm._s(_vm.postProp.title)),
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "py-1" }, [
          _vm._v(
            "\n                " +
              _vm._s(_vm.postProp.content) +
              "\n            "
          ),
        ]),
        _vm._v(" "),
    ...
    !_vm.formSubmitted
      ...
      : _c("div", { staticClass: "alert alert-success py-5" }, [
          ...
          _c("p", { staticClass: "lead" }, [
            _vm._v("La sua richiesta è stata inviata correttamente"),
          ]),
        ]),
  ])
}
  ...
  return _c("div", [
    _c(
      ...
      _vm._l(_vm.posts, function (post) {
        return _c("PostCard", {
          key: post.id,
          staticClass: "col-6 col-md-4 col-lg-3 col-xxl-2 my-3",
          attrs: { postProp: post },
        })
      }),
      1
...
var render = function () {
  ...
  return _c(
    ...
    [
      _c("TheNavbar"),
      _vm._v(" "),
      _c("div", { staticClass: "container my-5 py-5" }, [_c("router-view")], 1),
    ],
    1
  )
}
...
module.exports = __webpack_require__(/*! D:\BOOLEAN\Esercizi\laravel-boolpress\resources\js\vue.js */"./resources/js/vue.js");
